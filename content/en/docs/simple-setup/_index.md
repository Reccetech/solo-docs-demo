...
weight: 1000
aliases:
  - /docs/simple-setup/solo-user-guide/
  - /docs/solo-user-guide/
description: >
  Best for new users and quick local environments with minimal configuration.
type: docs
---
...
1. **[Using Solo with Hiero JavaScript SDK](../using-solo/javascript-sdk.md)** - Create accounts, topics, and submit transactions using the SDK.

2. **[Mirror Node Queries](../advanced-setup/advanced-deployments.md#8-deploy-mirror-node)** - Learn how to query the mirror node REST API at `http://localhost:5551`.

3. **[Advanced Network Deployments](../advanced-setup/advanced-deployments.md)** - Deploy networks with custom configurations using Falcon, manual step-by-step deployment, or add/delete nodes dynamically.
